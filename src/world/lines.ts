...
export const PEOPLE: PersonDef[] = [
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Stand under THE BELFRY when the lamps come on. One hand will agree with the lamps. Come and tell me which.'],
      done: ['There. Was that so hard? Forty years.', 'Cloth\'s out. Buy something or move along.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['There\'s a wet banner down by THE MOAT POOL. Carry it up the ramp and I\'ll hang it. Mind — it\'s heavy.'],
      done: ['Five. That\'s five. Brim\'s red on the fifth pole. I said it\'d be the red.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Get out on the water and find THE MARK. It\'s got a name. I\'d like to know it before I\'m done rowing.'],
      done: ['Eighth pot\'s out. On a bearing I never rowed. We\'ll see.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Walk THE SANDBAR to the end and tell me what\'s there. Two marks make a line.'],
      done: ['Second mark\'s down. There\'s a line now. Whether they use it is their business.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Go down to THE TARN and stand at the water. Somebody should, and it isn\'t going to be me.'],
      done: ['You stood at it. Then I can turn round. Forty years. My neck.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Follow the water. THE RIVERHEAD is north of here. Come back and tell me if it\'s the same river.'],
      done: ['Forty units. Forty. I could have walked it in an afternoon.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Walk the crease east of the Common, both faces. Then come to THE CATCH and tell me what the fold does.'],
      done: ['Lid\'s off. Listen. That\'s rain going in. First time.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['There\'s a place laid at THE HEADLAND for nobody in particular. Go and sit in it, if you like.'],
      done: ['You sat. Good. A place kept for nobody was always a place kept for anybody.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Go up to THE KEEP at Greyweather and bring its name back. Then we\'ll see about that hedge.'],
      done: ['There. Castle. Through the gap. I told June and June didn\'t believe me.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Stand here at THE JUNCTION with me. Four seconds. Just stand. That\'s all it is.'],
      done: ['You asked. That\'s all anyone had to do. I\'ll sit on the bench now.'],
  ...
  },
  {
    ...
    lines: {
      ...
      asked: ['Read the timetable at THE 8:15 STOP. Twelve names, in order. Then tell me which one you\'ve met.'],
      done: ['It\'s a list. The twelve are on it. In order. Now you know what I know.'],
