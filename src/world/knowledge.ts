...
export const WAIT_DOORS: Record<string, Known[]> = {
  ...
  beach: ['door:the-note-read', 'door:the-note-dropped', 'door:the-eighth-pot', 'door:the-pots-hauled'],
  ocean: ['door:the-old-rules', 'door:the-longship-in', 'door:the-second-mark', 'door:the-fleet-finished'],
  ...
  desert: ['door:the-rain-dated', 'door:the-rain-rubbed', 'door:the-lid-off', 'door:the-cistern-yours'],
