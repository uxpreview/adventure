...
| 16 | **The first hour** | The opening (`THE-FUN-PASS` §11: THE BULL, THE FOUR LURES, THE COMMON AS THE PLATEAU); the co-walker as a rule of the world (`critique-story-2` MANDATORY 1); the goat as the second co-walker; the Common's districts; NELL's wait with two doors; the first minute re-shot and its verdict re-earned. The story gate re-run on Act I. |
