...
| 17 | **Life** | Unnamed inhabitants with routines in every land; the animals; weather (rain, wind, fog); night as a different game; scheduled events on the clock in every land. `check-fields` extended to routines. |
