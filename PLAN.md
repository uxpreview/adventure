...
| 18 | **The roads** | The twenty-eight encounters built; DISTRICTS in all twelve lands; the fifteen-second rule measured by a tool that walks every road and fails on silence; **THE BICYCLE and THE PAPER PLANE** (the plane's fourth deferral is its last); the 8:15 as daily transit after the ending. |
