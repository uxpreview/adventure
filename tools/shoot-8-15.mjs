...
const SHOTS = [
  ...
  /* ---- THE 8:15 READS THE DOORS (Session 21, `THE-FUN-PASS` §6) -----
   * The same stops, with the other door taken: two cans on the Flats'
   * platform where Amos would have stood, seven pots on Longshore's
   * where Pye would have, nobody at all on Splitrock's with the sea
   * told to Holt, Marget on Brim's with the clock set to her hand —
